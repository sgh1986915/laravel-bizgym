...
<div class='row-fluid admin menu-item' id='content-wrapper'>
    <div class='span12'>
        ...
        <div class='row-fluid section-header'>
            <div class='title'>
                Create a New Alert for your Application
            </div><!--/.title-->
                    ...
                    <form class='form'>
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class='controls'>
                                    <textarea id='inputTextArea1' class='span9' placeholder='Text for your alert' rows='3'></textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
                            ...
                            <div class="control-group">
                                ...
                                <div class='controls'>
                                    <div class='datetimepicker input-append' id='datetimepicker'>
                                            <input class='input-medium' data-format='MM/dd/yyyy HH:mm:ss PP' placeholder='Select expiration' type='text'>
                                            <span class='add-on'>
