...
<div class='row-fluid admin menu-item' id='content-wrapper'>
    <div class='span12'>
        ...
        <div class='row-fluid section-header'>
            <div class='title'>
                Create a new Subscription Plan for your Application
            </div><!--/.title-->
                        ...
                        <fieldset>
                            <div class='control-group'>
                                ...
                                <div class='controls'><p class='help-block'>What should you call this plan?</p>
                                    ...
                                    <input class='span6' id='plan-name' placeholder='Ex: Pro' type='text'>
                            ...
                            <div class="control-group">
                                ...
                                <div class='controls'>
                                    <textarea id='inputTextArea1' class='span6' placeholder='This plan is for users who want to manage 5 companies' rows='3'></textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
