...
<div class='row-fluid admin' id='content-wrapper'>
    <div class='span12'>
        ...
        <div class='row-fluid section-header'>
            <div class='title'>
                Create a new Group with special permissions
            </div><!--/.title-->
                                ...
                                <div class='span8'>
                                    <div class='control-group'>
                                        ...
                                        <div class='controls'>
                                            ...
                                            <input class='span9' id='question-name' placeholder='Ex: Subscribers' type='text'>
                                    ...
                                    <div class='control-group'>
                                        ...
                                        <div class='controls'>
                                            <select id="group-type" class="" name="priority">
                                                ...
                                                <option selected="selected" value="0">System</option>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <label class='checkbox'><input type='checkbox' value=''>Create a Brand</label>
                                            <label class='checkbox'><input type='checkbox' value=''>Delete a Brand</label>
                                            <label class='checkbox'><input type='checkbox' value=''>Download Marketplace items</label>
                                        </div><!--/.controls-->
                                    </div> <!--/.control-group-->
