                            ...
                            <div class='row-fluid'>
                                <div class='span8'>
                                    <div class='control-group'>
                                        ...
                                        <div class='controls'>
                                            <input class='span9' id='rule-name' value='Create a Brand' type='text'>
                                        </div><!--/.controls-->
                                    </div><!--/.control-group-->
                                    ...
                                    <div class='control-group'>
                                        ...
                                        <div class='controls'>
                                            ...
                                            <input class='span9' id='rule-slug' value='brand_create' type='text'>
                                    ...
                                    <div class='control-group'>
                                        ...
                                        <div class='controls'>
                                            <textarea id='inputTextArea1' class='span9' placeholder='Describe your rule' rows='3'>Create a Brand</textarea>
                                        </div><!--/.controls-->
                                    </div><!--/.control-group-->
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class='checkbox'><input type='checkbox' value='' checked>Administrator</label>
