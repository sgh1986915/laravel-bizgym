...
<div class='row-fluid admin new-message' id='content-wrapper'>
    <div class='span12'>
            ...
            <div class='page-header' style=''>
                ...
                <div class='pull-left'>
                    <h3>
                        ...
                        <span>Create New Message Group</span>
                    </h3>
                </div><!--/.pull-left-->
        ...
        <div class='row-fluid section-header'>
            <div class='title'>
                Create a new group to send messages to
            </div><!--/.title-->
                    ...
                    <form class='form'>
                        <fieldset>
                            <div class='control-group'>
                                ...
                                <div class="controls">
                                    <input class='span6' id='group-name' placeholder='ex: Users' type='text'>
                            ...
                            <div class="control-group">
                                ...
                                <div class='controls'>
                                    <textarea id='group-description' placeholder='Description' class='span12'rows='3'> </textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
