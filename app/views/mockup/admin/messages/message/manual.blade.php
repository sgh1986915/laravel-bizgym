            ...
            <div class='page-header' style=''>
                ...
                <div class='pull-left'>
                    <h3>
                        ...
                        <span>Send a Manaul Message</span>
                    </h3>
                </div><!--/.pull-left-->
                ...
                <div class='box-content'>
                    <form class='form form-horizontal'>
                        <fieldset>
                            ...
                            <div class="control-group">
                                <label class="control-label" for="focusedInput">Recipient(s)</label>
                                <div class='controls'>
                                    <select class='select2 input-block-level' multiple placeholder='Type the name of a Group or a User'>
                                        
                                        <option value='0'>Subscribers</option>
                                        <option value='1'>All</option>
                                        <option value='2'>Bob User</option>
                                        <option value='3'>Jim Bob</option>
                                        <option value='4'>Smith Bob</option>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea id='inputTextArea1' class='input-block-level' placeholder='Text for your message' rows='8'></textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
