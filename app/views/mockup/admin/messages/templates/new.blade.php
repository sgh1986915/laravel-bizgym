...
<div class='row-fluid admin new-message' id='content-wrapper'>
    <div class='span12'>
        ...
        <div class='row-fluid section-header'>
            ...
            <div class='btn-group'>
                <a class='btn btn-default' role='button'>Go Back to Templates</a>
            </div><!--/.btn-group-->
                    ...
                    <form class='form'>
                        <fieldset>
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input class='span6' id='name' placeholder='ex: Christmas Card' type='text'>
                                </div><!--/.controls-->
                            </div><!--/.control-group-->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea id='templatebody' class='span12' placeholder='Text for your message' rows='32'></textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
