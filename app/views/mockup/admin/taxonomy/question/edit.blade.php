    ...
    <div class='span12'>
        ...
        <div class='row-fluid section-header'>
            ...
            <div class='btn-group'>
                ...
                <a class='btn btn-default user-action-btn' role='button'><i class='icon-trash'> </i> Delete this Question</a>
            </div><!--/.btn-group-->
                    ...
                    <div class='row-fluid'>
                        <div class='span8'>
                            ...
                            <div class='control-group'>
                                ...
                                <div class='controls'>
                                    <input class='span9' id='sub-category-name' placeholder='Ex: Competition Overview' value='Who is your main competitor?' type='text'>
                                </div><!--/.controls-->
                            </div><!--/.control-group-->
                            ...
                            <div class="control-group">
                                ...
                                <textarea class="span12 wysihtml5" cols="40" id="tips_content" name="body[]" placeholder="Some text here..." rows="10">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span12 ckeditor" cols="40" id="examples_content" placeholder="Some text here..." rows="10">Enter some information yaddda yadda</textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span12 wysihtml5" cols="40" id="quotes_content" placeholder="Some text here..." rows="10">Enter some information yaddda yadda</textarea>
                                </div><!--/.controls-->
                            </div> <!--/.control-group-->
                            ...
                            <div class="control-group">
                                <label class="control-label" for="focusedInput">Allow multiple responses to this question?</label><p class='help-block'>For example if you ask what an item's key features is, and you allow user to 'add another'. </p>
                                <div class="controls">
