    ...
    <div class='span12'>
        ...
        <div class='row-fluid section-header'>
            ...
            <div class='btn-group'>
                ...
                <a class='btn btn-default user-action-btn' role='button'><i class='icon-trash'> </i> Delete this Sub-Category</a>
            </div><!--/.btn-group-->
                        ...
                        <div class='row-fluid'>
                            <div class='span8'>
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input class='span9' id='sub-category-name' placeholder='Ex: Competition Overview' value='Funding' type='text'>
                                    </div><!--/.controls-->
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <textarea id='introduction_statement' class='span9' placeholder='Describe your sub-category' rows='3'>Enter some text yadda yadda</textarea>
                                    </div><!--/.controls-->
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input class='span9' id='sub-category-name' placeholder='Ex: Customer Overview' value='Click Me' type='text'>
                                    </div><!--/.controls-->
                                </div><!--/.control-group-->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span12 wysihtml5" cols="40" id="tips_content" placeholder="Some text here..." rows="10">Enter some text yadda yadda</textarea>
                                    </div><!--/.controls-->
                                </div> <!--/.control-group-->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span12 wysihtml5" cols="40" id="examples_content" placeholder="Some text here..." rows="10">Enter some text yadda yadda</textarea>
                                    </div><!--/.controls-->
                                </div> <!--/.control-group-->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span12 wysihtml5" cols="40" id="quotes_content" placeholder="Some text here..." rows="10">Enter some text yadda yadda</textarea>
                                    </div><!--/.controls-->
                                </div> <!--/.control-group-->
