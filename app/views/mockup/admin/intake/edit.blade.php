                                ...
                                <div class='span8'>
                                    <div class='control-group'>
                                        ...
                                        <div class='controls'><p class='help-block'>What do you want to ask your user?</p>
                                            ...
                                            <input class='span9' id='question-name' value='Who is Your Audience?' type='text'>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class='controls'>
                                            <textarea id='question-text' class='span9' placeholder='Question Helper Text' rows='3'>Tell us about your primary audience</textarea>
                                        </div><!--/.controls-->
                                    </div> <!--/.control-group-->
                        ...
                        <div class='span8'>
                            <div class='control-group'>
                                ...
                                <div class='controls'><p class='help-block'>Name a possible response to your question</p>
                                    <input class='span9' id='answer-value' placeholder='Ex: Blue' type='text'>
                                </div><!--/.controls-->
                            </div><!--/.control-group-->
                                ...
                                <table class='table table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td data-title='Values'><span class='label'>Entity -> Business <a href='#'> <i class='icon-remove'></i></a></span></td>
                                            <td data-title='Actons'>
                                                <a class='btn btn-mini' href='#edit-answer' role='button' data-toggle='modal'>Edit</a>
                                                <a class='btn btn-mini' href='#add-value' role='button' data-toggle='modal'>Add a Value</a> 
...
<div class='modal add-value hide fade' id='add-value' role='dialog' tabindex='-1'>
    <div class='modal-header red-background'>
        <button class='close' data-dismiss='modal' type='button'>&times;</button>
        <h3>Add a Value</h3>
    </div><!--/.modal-header-->
    <div class='modal-body'>
        <form>
            ...
            <div class="control-group">
                <p class='help-block'>Add a value to this answer to use it to categorize users based on responses. These values are configured in your defintions.</p>
                <div class="controls">
                    <div class='row-fluid'>
    ...
    <div class='modal-footer'>
        <button class='btn btn-default' data-dismiss='modal'><i class='icon-remove'> </i> Cancel</button>
         <button class='btn btn-default btn-primary' data-dismiss='modal'><i class='icon-add-new'> </i> Save Value</button>
    </div><!--/.modal-footer-->
</div><!--/.modal hide fade-->
