        ...
        <div class='row-fluid'>
            <div class='span12 box' style='margin-bottom: 0'>
                <div class='box-header purple-background'>
                    <div class='title'>Create a Goal</div>
                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What will you call this goal?</label>
                                        </div>
                                            ...
                                            <div class='tabbable'>
                                                <div class='box-header background-gray'>
                                                    <ul class='nav nav-tabs span8'>
                                                        ...
                                                        <li class=''>
                                                            <a data-toggle='tab' href='#examples-1'>
                                    ...
                                    <div class='controls'>
                                        <input id="GoalName" class='span12' placeholder="name" type='text'>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Describe your goal</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Who is responsible for this goal?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                        ...
                                        <div class='span12 box'>
                                            <div class='tabbable'>
                                                <div class='box-header background-gray'>
                                                    ...
                                                    <div class='actions'>
                                                        <a href="" class="btn btn-mini btn-link" data-toggle='collapse' data-target='#resource-3'><i class='icon-remove'></i>
                                                        </a>
                                                    </div>
                                                    </div><!--/.box-header-->
                                                    <div class='box-content'>
