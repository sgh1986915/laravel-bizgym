        ...
        <div class='span12'>
            ...
            <div class='row-fluid'>
                <div class='section-header'>
                    ...
                    <div class='bizgym-tip'>
                            <div class='btn btn-default has-popover' data-content='It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).' data-placement='right' data-title='What is Your Market?'><i class="icon-info"></i>
                            </div><!--/.popover-->
                    </div><!--/.bizgym-tip-->

                     <a class='btn pull-right btn-default'><i class='icon-plus-sign'> </i> Add New Goal</a>
                </div><!--/.section-header-->
            </div><!--/.row-flui-->


            <div class='row-fluid goal'>
                <div class='box'>
                    <div class='box-content'>
                        <div class='row-fluid goal-details'>
                            <div class='row-fluid'>
                                <div class='title'>Sell 300 Units</div><!--/.title-->
                                <a class='btn pull-right btn-default'><i class='icon-pencil'> </i> Edit Goal</a>
                            </div><!--/.row-fluid-->
                            <div class='row-fluid'>
                                <div class='span10'>
                                    <span class='responsible'>All are Responsible</span>
            ...
            <div class='row-fluid'>
                <div class='section-buttons'>
                    <a class='btn btn-large btn-default edit-section' href='#next'>
                        <i class='icon-pencil'> </i> Add New Goal
                    </a>
