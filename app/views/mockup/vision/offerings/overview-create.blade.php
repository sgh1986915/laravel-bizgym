            ...
            <div class='row-fluid'>
                <div class='span12 box' style='margin-bottom: 0'>
                    <div class='box-header purple-background'>
                        <div class='title'>Overview of Offerings</div>
                            ...
                            <div class='row-fluid section-intake'>
                                <div class='span8'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What are the benefits of your offerings?</label>
                                            </div>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What are the main features of your offerings?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What are your claims?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
