...
<div class='row-fluid vision-view funding' id='content-wrapper'>
        <div class='span12'>
            <div class="row-fluid">
            ...
            <div class='row-fluid'>
                <div class='span12 box box-bordered-box'>
                    <div class='box-header'>
                        ...
                        <a class='edit-profile btn btn-small'><i class='icon-edit'> </i> Edit Funding</a>
                    ...
                    <div class='box-content division'>
                        <div class='row-fluid'>
                            <div class='span11'>
                                ...
                                <div class='section'>
                                    <div class='section-title'>Funding Plan</div>
                                    <h5 class='section-header'>"We intend to get funded and do work"</h5>
                                ...
                                <div class='section'>
                                    ...
                                    <h5 class='section-header'>"Over 1000 products sold in the last month"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->

                                <div class='section'>
                                    <div class='section-title'>Current Stage</div>
                                    <h5 class='section-header'>"Currently in the Validation Stage"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->

                                <div class='section'>
                                    <div class='section-title'>Investor Risk</div>
                                    <h5 class='section-header'>"Zero risk, 200% Returns"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->


                                <div class='section'>
                                    <div class='section-title'>ROI & Exit Plan</div>
                                    <h5 class='section-header'>"Make a Profit and Change the World"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->

                                <div class='section'>
                                    <div class='section-title'>Funding Request</div>
                                    <h5 class='section-header'>"$600k for 5% Stake"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->
