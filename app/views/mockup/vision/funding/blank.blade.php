            ...
            <div class='row-fluid'>
                <div class='box'>
                    <div class='span12 box-content'>
                        <div class='span8'>
                            <h2>Describe how your company plans to get funding, and what you would do if awarded funding</h2>
                        </div><!--/.span8-->
                        <div class='span4 get-started'>
                            <button style='margin-top:15%;'class='btn btn-block btn-large btn-success'>Create Funding Plan
                            </button>
                        </div><!--/.span4-->
                    </div><!--/.box-content-->
                </div><!--/.box-->
