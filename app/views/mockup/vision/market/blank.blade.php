        ...
        <div class='row-fluid'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>Describe the market that you are competing in and how you will succeed.</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button style='margin-top:5%;'class='btn btn-block btn-large btn-success'>Your Market
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
