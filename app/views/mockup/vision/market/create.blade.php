        ...
        <div class='row-fluid'>
            <div class='span12 box' style='margin-bottom: 0'>
                <div class='box-header purple-background'>
                    <div class='title'>Your Market</div>
                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your market situation?</label>
                                        </div>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your solution?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Market Definition</label> 
                                        </div>
                                            ...
                                            <div class='tabbable'>
                                                <div class='box-header background-gray'>
                                                    <ul class='nav nav-tabs span8'>
                                                        ...
                                                        <li class=''>
                                                            <a data-toggle='tab' href='#examples-3'>
                                                                <i class="icon-beaker"></i>Example
                                                            </a>
                                                        </li>
                                                        <li class=''>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Market Size</label> 
                                        </div><!--/.span6-->
