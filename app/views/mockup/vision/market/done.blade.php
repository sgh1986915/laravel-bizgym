                ...
                <div class='span12 box box-bordered-box'>
                    <div class='box-header'>
                        ...
                        <div class='bizgym-tip'>
                            <div class='btn btn-default has-popover' data-content='Your Company Overview is important information' data-placement='right' data-title='What is Your Market'><i class="icon-info"></i>
                        </div><!--/.popover-->
                        </div><!--/.bizgym-tip-->
                        <div class="actions">
                        ...
                        <a class='edit-content btn btn-small'><i class='icon-edit'> </i> Edit Market</a>
                    ...
                    <div class='box-content'>
                        <div class='row-fluid'>
                            <div class='span11'>
                                ...
                                <div class='section'>
                                    <div class='section-title'>Market Situation</div>
                                    <h5 class='section-header'>"Lorem ipsum dolor sit amet, consectetuer adipiscing elit"</h5>
                                ...
                                <div class='section'>
                                    <div class='section-title'>Market Definition</div>
                                    <h5 class='section-header'>"Lorem ipsum dolor sit amet, consectetuer adipiscing elit"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->

                                <div class='section'>
                                    <div class='section-title'>Market Size</div>
                                    <h5 class='section-header'>"Lorem ipsum dolor sit amet, consectetuer adipiscing elit"</h5>
                                    <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                                </div><!--/.section-->
