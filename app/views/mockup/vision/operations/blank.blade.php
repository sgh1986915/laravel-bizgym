    ...
    <div class='span12'>
        ...
        <div class='row-fluid'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>Answer a few questions about the overview of your business operations</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button class='btn btn-block btn-large btn-success'>Operations Overview
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
        ...
        <div class='row-fluid shift-down'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>Define the different divisions that form your company</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button class='btn btn-block btn-large btn-success'>Division Profiles
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
