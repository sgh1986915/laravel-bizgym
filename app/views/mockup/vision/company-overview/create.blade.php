            ...
            <div class="row-fluid">
                <div class='page-header'>
                    <h3 class='pull-left'>
                        ...
                        <span>Vision</span><i id="arrow-after-main" class="icon-double-angle-right"></i> <span class="heading-small">Company Overview</span>
                    </h3>
                        ...
                        <div class='tabbable collapse' id='resources'>
                            <div class='box-toolbox box-toolbox-top resource-bar'>
                                <ul class='nav nav-tabs resources-list'>
                                    <li class='active'><a data-toggle='tab' href='#tips'><i class='icon-lightbulb'></i>Tips</a></li>
                            ...
                            <div class='row-fluid section-intake'>
                                <div class='span8'>
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What is your business model?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                                    <a class="btn show-Tips btn-white" href="" data-toggle='collapse' data-target='#resource-1'>
                                                        <i class="icon-lightbulb"></i>
                                                    </a>
                                                    <a class="btn show-examples btn-white" href="" data-toggle='collapse' data-target='#resource-1'>
                                            ...
                                            <div class='span12 box'>
                                                <div class='tabbable'>
                                                    <div class='box-header background-gray'>
                                                        ...
                                                        <div class='actions'>
                                                            <a href="" class="btn btn-mini btn-link" data-toggle='collapse' data-target='#resource-1'><i class='icon-remove'></i>
                                                            </a>
                                                        </div>
                                                        </div><!--/.box-header-->
                                                        <div class='box-content'>
                                        ...
                                        <div class='controls'>
                                            <input id='text1' class='span12' type='text' placeholder='Money Model'>
                                            <textarea id="inputTextArea1" class='span12' rows="3" placeholder="description"></textarea>
                                        </div>
                                    </div><!--/.control-group-->
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Describe your entitlements</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                                    <a class="btn show-Tips btn-white" href="" data-toggle='collapse' data-target='#resource-2'>
                                                        <i class="icon-lightbulb"></i>
                                                    </a>
                                                    <a class="btn show-examples btn-white" href="" data-toggle='collapse' data-target='#resource-2'>
                                                        <i class="icon-beaker"></i>
                                                    </a>
                                            ...
                                            <div class='span12 box'>
                                                <div class='tabbable'>
                                                    <div class='box-header background-gray'>
                                                        ...
                                                        <div class='actions'>
                                                             <a href="" class="btn btn-mini btn-link" data-toggle='collapse' data-target='#resource-2'><i class='icon-remove'></i>
                                                            </a>
                                                            </a>
                                                        </div>
                                                        </div><!--/.box-header-->
                                        ...
                                        <div class='controls'>
                                            <input id='text1' class='span12' type='text' placeholder='Market Protections'>
                                            <textarea id="inputTextArea1" class='span12' rows="3" placeholder="description"></textarea>
                                        </div>
                                    </div><!--/.control-group-->
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What key trends are you leveraging?</label> 
                                            </div>
                                            ...
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                                    ...
                                                    <a class="btn show-Tips btn-white" href="" data-toggle='collapse' data-target='#resource-3'>
                                                        <i class="icon-lightbulb"></i>
                                                    </a>
                                                    <a class="btn show-examples btn-white" href="" data-toggle='collapse' data-target='#resource-3'>
                                                        <i class="icon-beaker"></i>
                                                    </a>
                                            ...
                                            <div class='span12 box'>
                                                <div class='tabbable'>
                                                    <div class='box-header background-gray'>
                                                        ...
                                                        <div class='actions'>
                                                             <a href="" class="btn btn-mini btn-link" data-toggle='collapse' data-target=''><i class='icon-remove'></i>
                                                            </a>
                                                        </div>
                                                        </div><!--/.box-header-->
                                                        <div class='box-content'>
                                        ...
                                        <div class='controls'>
                                            <input id='text1' class='span12' type='text' placeholder='Helpful Trends'>
                                            <textarea id="inputTextArea1" class='span12' rows="3" placeholder="description"></textarea>
                                        </div>
                                    </div><!--/.control-group-->
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Does your company have any partnerships?</label> 
                                            </div><!--/.span6-->

                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                                    
                                                    <a class="btn show-Tips btn-white" href="" data-toggle='collapse' data-target='#resource-4'>
                                                        <i class="icon-lightbulb"></i>
                                                    </a>
                                                    <a class="btn show-examples btn-white" href="" data-toggle='collapse' data-target='#resource-4'>
                                                        <i class="icon-beaker"></i>
                                                    </a>
                                            ...
                                            <div class='span12 box'>
                                                <div class='tabbable'>
                                                    <div class='box-header background-gray'>
                                                        ...
                                                        <div class='actions'>
                                                             <a href="" class="btn btn-mini btn-link" data-toggle='collapse' data-target='#resource-4'><i class='icon-remove'></i>
                                                            </a>
                                                        </div>
                                                        </div><!--/.box-header-->
                                                        <div class='box-content'>
