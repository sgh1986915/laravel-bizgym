            ...
            <div class='row-fluid'>
                <div class='span12 box' style='margin-bottom: 0'>
                    <div class='box-header purple-background'>
                        <div class='title'>Competitor Profile</div>
                            ...
                            <div class='row-fluid section-intake'>
                                <div class='span8'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Competitor Name</label>
                                            </div>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Describe your competitor</label>
                                            </div>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What are your competitor's strengths?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What are your competitor's weaknesses?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                ...
                                <div class='span4 upload-options'>
                                    <div class='row-fluid-shift-up'>
                                        <a id="import-customer" data-toggle='modal' href='#modal-import-competitor' role='button' class="btn btn-large" name="button">
                                            <span class='btn-title'>Not sure what to say?</span>
                                            Import a stock profile
                                        </a>
                                    </div><!--.row-fluid-->

                                    <div class='modal hide fade' id='modal-import-competitor' role='dialog' tabindex='-1'>
                                        <div class='modal-header'>
                                            <button class='close' data-dismiss='modal' type='button'>&times;</button>
                                            <h3>Import Competitor</h3>
                                        </div>
                                        <div class='modal-body'>
                                            <div class='row-fluid shift-up'>
                                    ...
                                    <div class='row-fluid shift-down'>
                                         <div class='span10 offset1 box no-photo'>
                                            <div class='box-content'>
                                                Upload a photo to represent your competitor
                                            </div><!--/.box-content-->
                                        </div><!--/.box-->
                                    </div><!--/.row-fluid-->
