        ...
        <div class="row-fluid">
            <div class='page-header'>
                <h3 class='pull-left'>
                    ...
                    <span>Vision</span><i id="arrow-after-main" class="icon-double-angle-right"></i> <span class="heading-small">Management</span>
                </h3>
        ...
        <div class='row-fluid'>
            <div class='span12 box' style='margin-bottom: 0'>
                <div class='box-header purple-background'>
                    <div class='title'>Management Profile</div>
                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is the name of this individual?</label>
                                        </div>
                                    ...
                                    <div class='controls'>
                                        <input id='management-name' placeholder='John Smith' class='span12' type='text'>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is this person's title?</label>
                                        </div>
                                    ...
                                    <div class='controls'>
                                        <input id='text1' class='span12' type='text' placeholder='title'>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Describe this person's role</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Decribe this person's qualifications</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                            ...
                            <div class='span4 upload-options'>
                                ...
                                <div class='modal-header'>
                                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                                    <h3>Import Management Profile</h3>
                                </div>
                                <div class='modal-body'>
                                    <div class='row-fluid shift-up'>
                                        ...
                                        <div class='span6 profile-box'>
                                            <div class='box-content'>
                                                ...
                                                <div class='row-fluid'>
                                                    ...
                                                    <a class='btn btn btn-primary'>COO</a>
                                                </div><!--/.row-fluid-->
                                            </div><!--/.box-content-->
                                ...
                                <div class='row-fluid shift-down'>
                                     <div class='span10 offset1 box no-photo'>
                                        <div class='box-content'>
                                            Upload a photo to represent your manager
                                        </div><!--/.box-content-->
                                    </div><!--/.box-->
                                </div><!--/.row-fluid-->
