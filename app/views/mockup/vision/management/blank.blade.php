    ...
    <div class='span12'>
        ...
        <div class='row-fluid'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>How will your team work together? What will motivate your team?</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button class='btn btn-block btn-large btn-success'>Management Overview
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
        ...
        <div class='row-fluid shift-down'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>Create profiles for the important people in your company</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button class='btn btn-block btn-large btn-success'>Management  Profiles
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
