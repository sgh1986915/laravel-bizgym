        ...
        <div class='span12'>
            ...
            <div class="row-fluid section-header">
                    ...
                    <div class='bizgym-tip'>
                            <div class='btn btn-default has-popover' data-content='Your Company Overview is important information' data-placement='right' data-title='Who are the important people in your company?'><i class="icon-info"></i>
                            </div><!--/.popover-->
                    </div><!--/.bizgym-tip-->
            ...
            <div class='row-fluid profiles'>
                <div class='span4 box profile management'>
                    <div class='box-content'>
                        <div class='row-fluid'>
                            <div class='title'>
                                Jimmy Johnson
                        ...
                        <div class='profile-details'>
                            ...
                            <div class='row-fluid description'>
                                <p>Jimmy runs the company and takes care of everything</p>
                            </div><!--/.row-fluid description-->

                            <div class='row-fluid demographics'>
                                <h4>Qualifications</h4>
                                <p>Harvard Graduate, previous VP of Lemonade Juice United</p>
                            </div><!--/.row-fluid description-->
                ...
                <div class='span4 box profile management'>
                    <div class='box-content'>
                        ...
                        <div class='profile-details'>
                            ...
                            <div class='row-fluid description'>
                                <p>Tara looks good and gets the finances in order</p>
                            </div><!--/.row-fluid description-->

                            <div class='row-fluid demographics'>
                                <h4>Qualifications</h4>
                                <p>Yale Graduate, previous treasurer of Van Wilder Enterprises</p>
                            </div><!--/.row-fluid description-->
                ...
                <div class='span4 box profile management'>
                    <div class='box-content'>
                        ...
                        <div class='profile-details'>
                            ...
                            <div class='row-fluid description'>
                                <p>Bobby keeps everyone in line</p>
                            </div><!--/.row-fluid description-->

                            <div class='row-fluid demographics'>
                                <h4>Qualifications</h4>
                                <p>Basketball star, graudate of Human Resources School</p>
                            </div><!--/.row-fluid description-->
            ...
            <div class='row-fluid'>
                <div class='span12 box box-bordered-box'>
                    <div class='box-header'>
                        ...
                        <div class='bizgym-tip'>
                            <div class='btn btn-default has-popover' data-content='Your Company Overview is important information' data-placement='right' data-title='What is the Management Overview?'><i class="icon-info"></i>
                        </div><!--/.popover-->
                        </div><!--/.bizgym-tip-->
                        <div class="actions">
                    ...
                    <div class='box-content'>
                        <div class='row-fluid'>
                            <div class='span11'>
                                ...
                                <div class='section'>
                                    <div class='section-title'>Team Concept</div>
                                    <h5 class='section-header'>"Our team will work together through team building exercises and weekly meetings"</h5>
