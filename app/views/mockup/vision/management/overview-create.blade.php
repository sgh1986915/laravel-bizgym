        ...
        <div class='row-fluid'>
            <div class='span12 box' style='margin-bottom: 0'>
                <div class='box-header purple-background'>
                    <div class='title'>Management Overview</div>
                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Describe how your team will work together</label>
                                        </div>
                                    ...
                                    <div class='controls'>
                                        <input id='text1' class='span12' type='text' placeholder='team concept'>
