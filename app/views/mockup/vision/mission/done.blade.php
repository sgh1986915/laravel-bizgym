        ...
        <div class='row-fluid'>
            <div class='section-header'>
                ...
                <div class='bizgym-tip'>
                 ...
                 <a class='btn pull-right btn-default'><i class='icon-pencil'> </i> Edit</a>
            </div><!--/.section-header-->
            <div class='box'>
                <div class='span12 box-content mission-statement'>
                    <div class='span9'>
                        <p><span class='mission-item' id='company-name'>Bob's Bee Store</span> helps <span class='mission-item' id='target-customers'> bee keepers</span> get <span class='mission-item' id='key-benefits'>top-quality bee keeping sullies</span> through <span class='mission-item' id='solution-key-features'>an online marketplace featuring homemade honey and handcrafted smokers</span>.</p>
