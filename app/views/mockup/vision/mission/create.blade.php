        ...
        <div class="row-fluid">
            <div class='page-header'>
                <h3 class='pull-left'>
                    ...
                    <span>Vision</span><i id="arrow-after-main" class="icon-double-angle-right"></i> <span class="heading-small">Mission</span>
                </h3>
                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Who does your company help?</label>
                                        </div>
                                    ...
                                    <div class='controls'>
                                        <textarea id="inputTextArea1" class='span12' rows="3" placeholder="Target Customers"></textarea>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What are the benefits of your product or service?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                    ...
                                    <div class='controls'>
                                        <textarea id="inputTextArea1" class='span12' rows="3" placeholder="Key Benefits"></textarea>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your unique Solution?</label> 
                                        </div>
                                    ...
                                    <div class='controls'>
                                        <textarea id="inputTextArea1" class='span12' rows="3" placeholder="Unique Solution"></textarea>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What are the key features of your solution?</label> 
                                        </div><!--/.span6-->
                                    ...
                                    <div class='controls'>
                                        <textarea id="inputTextArea1" class='span12' rows="3" placeholder="Key Features"></textarea>
                                    </div><!--/.controls-->
                                </div><!--/.control-group-->
