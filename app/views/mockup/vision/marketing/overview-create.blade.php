                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your slogan?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                <a class="btn show-Tips btn-white" data-toggle='collapse' data-target='#resource-1'>
                                                    <i class="icon-lightbulb"></i>
                                                </a>
                                                <a class="btn show-examples btn-white" data-toggle='collapse' data-target='#resource-1'>
                                                    <i class="icon-beaker"></i>
                                                </a>
                                                <a class="btn show-quotes btn-white" data-toggle='collapse' data-target='#resource-1'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your overall marketing message?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your key claims statement?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your main promo strategy?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>How would you describe your key sales strategy?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
