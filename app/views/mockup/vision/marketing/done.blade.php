    ...
    <div class='span12'>
        ...
        <div class="row-fluid section-header">
            ...
            <div class='bizgym-tip'>
                    <div class='btn btn-default has-popover' data-content='Your Competitor Profiles are important information' data-placement='right' data-title='Marketing Campaigns?'><i class="icon-info"></i>
                    </div><!--/.popover-->
            </div><!--/.bizgym-tip-->
                        ...
                        <div class='box-content'>
                            ...
                            <div class='row-fluid'> 
                                <div class='image'>
                                    ...
                                    <a class='edit-profile btn btn-default'>View Campaign</a>
                                </div><!--/.image-->
                            </div><!--/.row-fluid-->

                            <div class='campaign-details'>
                                <ul class='campaign-list unstyled list-striped'>
        ...
        <div class='row-fluid'>
            <div class='span12 box box-bordered-box'>
                <div class='box-header'>
                    ...
                    <div class='bizgym-tip'>
                        <div class='btn btn-default has-popover' data-content='Your Company Overview is important information' data-placement='right' data-title='What is the Marketing Overview?'><i class="icon-info"></i>
                    </div><!--/.popover-->
                    </div><!--/.bizgym-tip-->
                    <div class="actions">
                ...
                <div class='box-content'>
                    <div class='row-fluid'>
                        <div class='span11'>
                            ...
                            <div class='section'>
                                <div class='section-title'>Slogan</div>
                                <h5 class='section-header'>"The generated Lorem Ipsum is therefore always free from repetition"</h5>
                            ...
                            <div class='section'>
                                <div class='section-title'>Promo Stragtegy</div>
                                <h5 class='section-header'>"The generated Lorem Ipsum is therefore always free from repetition"</h5>
                                <div class='section-description'>Take us to the top of our industry. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages,</div><!--/.section-dsecription-->
                            </div><!--/.section-->
