...
<div class='row-fluid create offerings campaign' id='content-wrapper'>
    <div class='span12'>
        <div class="row-fluid">
                        ...
                        <div class='row-fluid section-intake'>
                            <div class='span8'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Name of Campaign</label>
                                        </div>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Campaign Description</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                ...
                                                <a class="btn show-quotes btn-white" data-toggle='collapse' data-target='#resource-2'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Where will this campaign be in action?</label>
                                        </div>
                                    ...
                                    <div class='controls'>
                                        <input id='other' class='span6' type='text' placeholder='name of other medium'>
                                    </div>
                                </div><!--/.control-group-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Which Product is this campaign aimed at?</label>
                                        </div>
                                  
                                    </div><!--/.row-fluid-->
                                    <div class='row-fluid'>
                                        <div class='controls'>
                                            <select class='select2 input-block-level span6' multiple placeholder='Type name of existing product'>
                                    ...
                                    <div class='row-fluid'>
                                        <div class='controls shift-down'>
                                            <input id='other-product' class='span6' type='text' placeholder='Other Product'>
                                        </div>
                                    </div><!--/row-fluid-->
                                </div><!--/.control-group-->

                                <div class='control-group shift-up'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Campaign End Date?</label>
                                        </div>
                                ...
                                <div class='control-group shift-up'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>Campaign Launch Date?</label>
                                        </div>
                                ...
                                <div class='control-group shift-down'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your campaign's marketing message?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                <a class="btn show-Tips btn-white" data-toggle='collapse' data-target='#resource-2'>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your campaign's key claims statement?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                <a class="btn show-Tips btn-white" data-toggle='collapse' data-target='#resource-3'>
                                                    <i class="icon-lightbulb"></i>
                                                </a>
                                                <a class="btn show-examples btn-white" data-toggle='collapse' data-target='#resource-3'>
                                                    <i class="icon-beaker"></i>
                                                </a>
                                                <a class="btn show-quotes btn-white" data-toggle='collapse' data-target='#resource-3'>
                                                    <i class="icon-quote-right"></i>
                                                </a>
                                            </div><!--/.resource-buttons-->
                                        </div> <!--/.span4 field-resources-->
                                            ...
                                            <div class='tabbable'>
                                                <div class='box-header background-gray'>
                                                    <ul class='nav nav-tabs span8'>
                                                        ...
                                                        <li class=''>
                                                            <a data-toggle='tab' href='#quotes-3'>
                                                                <i class="icon-quote-right"></i>Quotes
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class='box-content'>
                                                        <div class='tab-content'>
                                                            <div class="tab-pane active" id="tips-3">
                                                                <p>Choose the right information about your benefits here. Be descriptive, but try to keep it short.</p>
                                                                <p>It's best to describe your benefits in 2-5 words</p>
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>What is your main promo strategy for this campaign?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                ...
                                                <a class="btn show-quotes btn-white" data-toggle='collapse' data-target='#resource-4'>
                                                    <i class="icon-quote-right"></i>
                                                </a>
                                            </div><!--/.resource-buttons-->
                                        </div> <!--/.span4 field-resources-->
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>How would you describe your sales strategy for this campaign?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                <a class="btn show-Tips btn-white" data-toggle='collapse' data-target='#resource-5'>
                                                    <i class="icon-lightbulb"></i>
                                                </a>
                                                <a class="btn show-examples btn-white" data-toggle='collapse' data-target='#resource-5'>
                                                    <i class="icon-beaker"></i>
                                                </a>
                                                <a class="btn show-quotes btn-white" data-toggle='collapse' data-target='#resource-5'>
                                                    <i class="icon-quote-right"></i>
                                                </a>
                                            </div><!--/.resource-buttons-->
                                        </div> <!--/.span4 field-resources-->
                                    ...
                                    <div class='row-fluid field-resource collapse' id='resource-5'>
                                        <div class='span12 box'>
                                            <div class='tabbable'>
                                                <div class='box-header background-gray'>
                                                    <ul class='nav nav-tabs span8'>
                                                        <li class='active'>
                                                            <a data-toggle='tab' href='#tips-5'>
                                                                <i class="icon-lightbulb"></i>Tips
                                                            </a>
                                                        </li>
                                                        <li class=''>
                                                            <a data-toggle='tab' href='#example-5'>
                                                                <i class="icon-beaker"></i>Example
                                                            </a>
                                                        </li>
                                                        <li class=''>
                                                            <a data-toggle='tab' href='#quotes-5'>
                                                                <i class="icon-quote-right"></i>Quotes
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class='actions'>
                                                        <a class="btn btn-mini btn-link" data-toggle='collapse' data-target='#resource-5'><i class='icon-remove'></i>
                                                        </a>
                                                    </div>
                                                    </div><!--/.box-header-->
                                                    <div class='box-content'>
                                                        <div class='tab-content'>
                                                            <div class="tab-pane active" id="tips-5">
                                                                <p>Choose the right information about your benefits here. Be descriptive, but try to keep it short.</p>
                                                                <p>It's best to describe your benefits in 2-5 words</p>

                                                            </div>
                                                            <div class="tab-pane " id="example-5"><p>Example of field</p>
                                                            </div>
                                                            <div class="tab-pane " id="quotes-5">
                                                                <blockquote>
                                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
                                                                    <small>
                                                                        Someone famous
                                ...
                                <div class='control-group'>
                                    <div class='row-fluid'>
                                        <div class='span8'>
                                            <label class='control-label' for='inputText'>How will you measure your ROI for this campaign?</label>
                                        </div>
                                        <div class='field-resources-links'>
                                            <div class='btn-group'>
                                                ...
                                                <a class="btn show-quotes btn-white" data-toggle='collapse' data-target='#resource-6'>
                                                    <i class="icon-quote-right"></i>
                                                </a>
                                            </div><!--/.resource-buttons-->
                                        </div> <!--/.span4 field-resources-->
                            ...
                            <div class='span4 upload-options'>
                                ...
                                <div class='row-fluid shift-down'>
                                     <div class='span10 offset1 box no-photo'>
                                        <div class='box-content'>
                                            Upload a photo to represent your campaign
                                        </div><!--/.box-content-->
                                    </div><!--/.box-->
                                </div><!--/.row-fluid-->
            ...
            <div class='span12 box' style='margin-bottom: 0'>
                ...
                <div class='box-content'>
                    ...
                    <div class='row-fluid section-intake'>
                        ...
                        <div class='span2 offset4 cost-total'>
                            Total:<span class='total-cost'>$50.00</span>
                        </div><!--/.span2 offset4-->
