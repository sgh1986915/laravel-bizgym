    ...
    <div class='span12'>
        ...
        <div class='row-fluid'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>Create a general overview of your company's Marketing efforts</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button class='btn btn-block btn-large btn-success'>Create Overview
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
        ...
        <div class='row-fluid shift-down'>
            <div class='box'>
                <div class='span12 box-content'>
                    <div class='span8'>
                        <h2>Outline individual marketing campaigns to detail your marketing strategy</h2>
                    </div><!--/.span8-->
                    <div class='span4 get-started'>
                        <button class='btn btn-block btn-large btn-success'>Create Campaign
                        </button>
                    </div><!--/.span4-->
                </div><!--/.box-content-->
            </div><!--/.box-->
