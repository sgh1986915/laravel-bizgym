        ...
        <div class='span12'>
            ...
            <div class='row-fluid'>
                <div class='box'>
                    <div class='span12 box-content'>
                        <div class='span8'>
                            <h2>Create a general overview of your customers to set your organization on track</h2>
                        </div><!--/.span8-->
                        <div class='span4 get-started'>
                            <button class='btn btn-block btn-large btn-success'>Customer Overview
                            </button>
                        </div><!--/.span4-->
                    </div><!--/.box-content-->
                </div><!--/.box-->
            ...
            <div class='row-fluid shift-down'>
                <div class='box'>
                    <div class='span12 box-content'>
                        <div class='span8'>
                            <h2>Create individual customer profiles for your business</h2>
                        </div><!--/.span8-->
                        <div class='span4 get-started'>
                            <button class='btn btn-block btn-large btn-success'>Customer Profiles
                            </button>
                        </div><!--/.span4-->
                    </div><!--/.box-content-->
                </div><!--/.box-->
