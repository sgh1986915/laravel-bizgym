                            ...
                            <div class='row-fluid section-intake'>
                                <div class='span8'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Describe your target customers</label>
                                            </div>
                                        ...
                                        <div class='controls'>
                                            <input id='text1' class='span12' type='text' placeholder='target customers'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Describe their purchasing patterns</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Describe your closers</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
