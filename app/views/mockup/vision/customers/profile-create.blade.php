                            ...
                            <div class='row-fluid section-intake'>
                                <div class='span8'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Describe your customer</label>
                                            </div>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What demographics are associated with this customer?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>What are your customer's aspirations?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                    ...
                                    <div class='control-group'>
                                        <div class='row-fluid'>
                                            <div class='span8'>
                                                <label class='control-label' for='inputText'>Who are your customer's influencers?</label>
                                            </div>
                                            <div class='field-resources-links'>
                                                <div class='btn-group'>
                                ...
                                <div class='span4 upload-options'>
                                    <div class='row-fluid-shift-up'>
                                        <a id="import-customer" data-toggle='modal' href='#modal-import-customer' role='button' class="btn btn-large" name="button">
                                            <span class='btn-title'>Not sure what to say?</span>
                                            Import a stock profile
                                        </a>
                                    </div><!--.row-fluid-->



                                    <div class='modal hide fade' id='modal-import-customer' role='dialog' tabindex='-1'>
                                    <div class='modal-header'>
                                        <button class='close' data-dismiss='modal' type='button'>&times;</button>
                                        ...
                                        <div class='row-fluid shift-up'>
                                            <div class='span6 profile-box'>
                                                <div class='box-content'>
                                                    ...
                                                    <div class='row-fluid'>
                                                        <div class='stock-photo shift-up'>
                                                    ...
                                                    <div class='row-fluid'>
                                                        ...
                                                        <a class='btn btn btn-primary'>Load Profile</a>
                                                    </div><!--/.row-fluid-->
                                                </div><!--/.box-content-->
                                                
                                            </div><!--/.span6 profile-box-->
                                    ...
                                    <div class='modal-footer'>
                                        <button class='btn btn-danger' data-dismiss='modal'><i class='icon-remove'> </i> Cancel</button>
                                    </div>
                                </div>
                                    ...
                                    <div class='row-fluid shift-down'>
                                         <div class='span10 offset1 box no-photo'>
                                            <div class='box-content'>
                                                Upload a photo to represent your customer
                                            </div><!--/.box-content-->
                                        </div><!--/.box-->
                                    </div><!--/.row-fluid-->
