...
<div class='row-fluid subscriptions' id='content-wrapper'>
    <div class='span12'>
        <div class="row-fluid">
            <div class='page-header' style=''>
                ...
                <div class='pull-right'>
                    <a class='btn btn-default' role='button'><i class='icon-barcode'> </i> Back to Subscriptions</a>
                </div>
            </div> <!--/.page-header-->
        </div> <!--/.row-fluid-->
        ...
        <div class='row-fluid profile-content'>
            ...
            <div class='span6'>
                <ul class='profile-meta unstyled'>
                    ...
                    <li><span class='item-title'>Payment Party:</span><a href='../../users/3/'>James Franco</a></li>
            ...
            <div class='span6'>
                <ul class='profile-meta unstyled'>
                    <li><span class='item-title'>Usage:</span>9/23 Seats Used</li>
                    <li><span class='item-title'>Last Payment:</span>9/19/2013</li>
                ...
                <div class='row-fluid shift-down'>
                    <a class='btn btn-default btn-primary'><i class='icon-edit'> </i>  Edit this Subscription</a> <a class='btn btn-default btn-primary'><i class='icon-group'> </i> Manage Team Members</a>
    ...
    <div class='modal hide fade' id='modal-transfer-subscription' role='dialog' tabindex='-1'>
        <div class='modal-header red-background'>
            <button class='close' data-dismiss='modal' type='button'>&times;</button>
