        ...
        <div class="row-fluid">
            <div class='page-header' style=''>
                ...
                <div class='pull-right'>
                	<a href="javascript:window.print()" class='btn btn-default'><i class='icon-print'> </i> Print Invoice</a>
                     <a href='../billing'class='btn btn-default'><i class='icon-list-alt'> </i> Return to Billing History</a>
                </div>
            </div> <!--/.page-header-->
        </div> <!--/.row-fluid-->
