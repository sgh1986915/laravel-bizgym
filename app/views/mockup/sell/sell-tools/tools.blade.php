...
<div class='row-fluid' id='content-wrapper'>
    <div class='span12 vision-tools'>
        ...
        <div class="row-fluid">
            <div class='page-header'>
                <div class="span9">
                    ...
                    <span class="heading-small">Selling Tools</span>
                    </h1>
                </div> <!--/.span9-->
        ...
        <div class="row-fluid marketplace">
            <div class="span3 box product">
                <div class='box-header'>
                    <div class='title'>Facebook Page</div><!--/.title-->
                </div><!--/.box-header-->
                <div class="box-content">
            ...
            <div class="span3 box product">
                <div class='box-header'>
                    <div class='title'>Website</div><!--/.title-->
                </div><!--/.box-header-->
                <div class="box-content">
                    <a href="marketplace/business-card.html"><div class="product-image">
                        <img src='http://placehold.it/200x150'>
            ...
            <div class="span3 box product">
                <div class='box-header'>
                    <div class='title'>Fancy Brochure</div><!--/.title-->
                </div><!--/.box-header-->
            ...
            <div class="span3 box product">
                <div class='box-header'>
                    <div class='title'>Twitter Profile</div><!--/.title-->
                </div><!--/.box-header-->
