        ...
        <div class="span8">
            ...
            <div class="box post">
                ...
                <div class="box-content">
                    ...
                    <input id="title" class="span8" type="text" name="title" placeholder='Post Title'>
                    ...
                    <div class="row-fluid add-tags">
                        <label for="tags"><i class='icon-tag muted'> </i> Add a Tag to your Post</label>
                    ...
                    <div class='row-fluid'>
                        ...
                        <button id="btn_submit" class="btn btn-large pull-right btn-success" type="submit">Publish this Post <i class='icon-share-alt'> </i> </button>
                    </div><!--/.row-fluid-->
