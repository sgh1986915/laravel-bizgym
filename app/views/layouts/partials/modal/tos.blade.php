<h1>Terms of Use</h1>
<h3>Terms of Service for {{ Config::get('app.name') }}</h3>
<strong>Introduction</strong>

<p>Welcome to {{ Config::get('app.url') }}. This website is owned and operated by {{ Config::get('app.name') }}, Inc.. By visiting our website and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as ‘User Agreement’), along with the terms and conditions as stated in our Privacy Policy (please refer to the Privacy Policy section below for more information).</p>
...
<p>Iiii. Impersonates any person or entity, including any {{ Config::get('app.url') }} employees or representatives.</p>
...
<p>vii) no information or advice, whether expressed, implied, oral or written, obtained by you from {{ Config::get('app.name') }}, Inc. or through any Resources we provide shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.</p>

<strong>Limitation of Liability</strong>

<p>In conjunction with the Limitation of Warranties as explained above, you expressly understand and agree that any claim against us shall be limited to the amount you paid, if any, for use of products and/or services. {{ Config::get('app.name') }}, Inc. will not be liable for any direct, indirect, incidental, consequential or exemplary loss or damages which may be incurred by you as a result of using our Resources, or as a result of any changes, data loss or corruption, cancellation, loss of access, or downtime to the full extent that applicable limitation of liability laws apply.</p>

<strong>Copyrights/Trademarks</strong>

<p>All content and materials available on {{ Config::get('app.url') }}, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of {{ Config::get('app.name') }}, Inc., and are protected by applicable copyright and trademark law. Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by {{ Config::get('app.name') }}, Inc..</p>
...
<strong>UNLESS OTHERWISE EXPRESSED, {{ Config::get('app.name') }}, Inc. EXPRESSLY DISCLAIMS ALL WARRANTIES AND CONDITIONS OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.</strong>

<strong>Contact Information</strong>

<p>If you have any questions or comments about these our Terms of Service as outlined above, you can contact us at:</p>

<p>{{ Config::get('app.name') }}, Inc.</p>
<p>1149 Bethel St., Suite 701</p>
